...
// NewPublisher 构造。
func NewPublisher(snaps *store.SnapshotStore, builder *Builder, sources *store.SourceStore) *Publisher {
	return &Publisher{snaps: snaps, builder: builder, sources: sources}
}
